...
class TodoSchema extends SchemaFactory implements Reusable
{
    ...
    public function build(): SchemaContract
    {
        return Schema::object('todo')
            ->properties(
                Schema::string('id')->format(Schema::FORMAT_UUID)->default(null),
                Schema::string('task')->default(null)->example('Write more todos'),
                Schema::boolean('completed')->default(false),
                Schema::string('user_id')->format(Schema::FORMAT_UUID)->default(null),
            ...
            ->required('id', 'title', 'description', 'user_id', 'created_at', 'updated_at');
    }
}
